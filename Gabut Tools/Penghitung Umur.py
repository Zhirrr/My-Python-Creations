...
############################################################
 ...
 [+] Author : Zhirrr
 [!] Note : Tools Ini Dibuat Karena Gabut :v
''')
...
if tanggal > 31 or tanggal == 0:
	exit('[!] Offside')
bulan = int(input('[?] Bulan (Contoh: 1): '))
...
if int(hari_ini[1]) == bulan and int(hari_ini[2]) == tanggal:
	print("\n[!] Selamat Ulang Tahun Beban Keluarga !")
else:
	print("\n[!] " + str(ultah) +" Hari Menuju Ulang Tahun")
print("[!] Gunakan Umurmu Sebaik Mungkin Dan Berhenti Jadi Beban!")
